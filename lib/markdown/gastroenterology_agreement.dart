const giAgreement = """
# Admission to GHS Gastroenterology
## Stable GI Bleed
...
** Patient is stable enough to be managed on the floor
...
* GI will discuss with the ED to assess if the patient can be discharged home or needs to be admitted. 
